...
export type FeatureFlagKey = 'parent_portal' | 'push_notifications' | 'student_photos' | 'study_space_tracking' | 'test_mode' | 'session_notes' | 'qr_sign_in' | 'awards' | 'analytics' | 'retrospective_sessions' | 'nfc_sign_in'
