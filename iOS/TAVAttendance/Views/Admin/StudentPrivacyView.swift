...
/// export, and erase / pseudonymise. Reached from StudentManagementView.
struct StudentPrivacyView: View {
    ...
    private var retentionSection: some View {
        Section {
            Label("Use the secure admin web dashboard", systemImage: "lock.shield")
        } header: {
            Text("Retention & Erasure")
        } footer: {
            Text("The web workflow removes private Storage objects before and after the irreversible database operation. Native direct erasure is disabled.")
        }
    }
    ...
    private func withdraw() async {
        ...
        do {
            try await AttendanceService.shared.withdrawConsent(studentId: student.id)
