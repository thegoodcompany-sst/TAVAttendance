...
| Migrations | `supabase db reset` (repo root) | All 16 migrations apply in order on a clean local DB. For a new migration also run its `.down.sql` then the forward again. |
